...
const translations = {
    ru: {
        ...
        aboutText3: "За время работы занималась проектированием backend-архитектуры с нуля, оптимизацией производительности API, автоматизацией CI/CD процессов и построением систем мониторинга. Люблю улучшать рабочие процессы в команде и помогать младшим сотрудникам с решением сложных вопросов.",
